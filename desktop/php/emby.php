...
sendVarToJS('eqType', 'emby');
$eqLogics = eqLogic::byType('emby');
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    ...
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        echo "<center>";
        if (file_exists(dirname(__FILE__) . '/../../doc/images/' . $eqLogic->getConfiguration('type') . '_icon.png')) {
          echo '<img src="plugins/emby/doc/images/' . $eqLogic->getConfiguration('type') . '_icon.png' . '" height="105" width="95" />';
        } else {
          echo '<img src="plugins/emby/doc/images/emby_icon.png" height="105" width="95" />';
        }
        echo "</center>";
        ...
        <form class="form-horizontal">
          <fieldset>
            <div class="form-group">
              <label class="col-sm-3 control-label">{{Nom du The Keys}}</label>
              <div class="col-sm-3">
                <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement emby}}"/>
              </div>
            </div>
            <div class="form-group">
...
<?php include_file('desktop', 'emby', 'js', 'emby'); ?>
